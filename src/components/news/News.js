...
export default class News extends Component{
  //TODO: Need to figure out how to assign different class names using the remainder operator to make display work as tiles
  ...
  render(){
    ...
    if(this.state.showNews === true){
      showNews= <NewsModule url={this.state.url} title={this.state.title} closeFunction={this.closeFunction} description={this.state.description} img={this.state.img}/>
    }
    return(
      <React.Fragment>
      {
